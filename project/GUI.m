...
% Last Modified by GUIDE v2.5 18-May-2017 01:42:58
...
cell = handles.cell;
    ...
    set(handles.text15,'String','choose method first.');
    return;
end
...
if(isempty(iterations))
     ...
     if(iterations < 0)
         set(handles.text15,'String','invalid number of iterations.');
         return;
     end
end
if(isempty(tolerance))
    ...
    if(tolerance < 0)
        set(handles.text15,'String','invalid tolerance.');
        return;
    end
end
    ...
    function histogramPlotForAllMethods(numOfIterations)
       ...
       %bisection in label for number of iterations. done.
       %fixed label converge or don't know. done
       %newton with plot.done
...
function pushbutton4_Callback(hObject, eventdata, handles)
    ...
    if(handles.i > r)
         handles.i = 1;%resut after finish.
    end
     handles.output = hObject;
     guidata(hObject,handles);
